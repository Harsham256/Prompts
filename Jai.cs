...
//        public string Password { get; set; } = string.Empty; // Plain password for checking
//    }
//}
...
//        public string Reason { get; set; } = string.Empty; // Red Flag Reason
//    }
//}
...
//    {
//        // Example method to validate land location
...
//    {
//        public string Key { get; set; } = string.Empty;     // From appsettings.json
//        public string Issuer { get; set; } = string.Empty;  // e.g., "TitleVerification.Api"
//        public string Audience { get; set; } = string.Empty; // e.g., "TitleVerification.Client"
//        public int ExpiryMinutes { get; set; } = 60; // e.g., 60
...
//        public string LandId { get; set; } = string.Empty;
//        public string OwnerName { get; set; } = string.Empty;
//        public string OwnershipType { get; set; } = string.Empty; // e.g., Inherited / Self
//        public string LandType { get; set; } = string.Empty;      // e.g., Agriculture / Forest / Government
...
//        public string LandId { get; set; } = string.Empty;
//        public string Status { get; set; } = string.Empty;         // Approved / Rejected
//        public string DecisionReason { get; set; } = string.Empty; // Red Flag Reason
//    }
//}
...
//// Load JwtSettings instance for DI
...
//                // Convert preprocessed image to Pix for Tesseract
//                using var ms = new MemoryStream();
...
//                Console.WriteLine("OCR Output: " + extractedText); // Debug OCR output
...
//            // Flexible regex for Land ID (handles common OCR mistakes)
